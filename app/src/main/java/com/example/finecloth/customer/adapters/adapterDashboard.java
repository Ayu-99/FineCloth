...
public class adapterDashboard extends RecyclerView.Adapter<adapterDashboard.Holder>{

    LayoutInflater layoutInflater;
    ArrayList<item> itemList;
    RecyclerViewClickInterface recyclerViewClickInterface;

    public adapterDashboard(ArrayList<item> itemList,RecyclerViewClickInterface recyclerViewClickInterface){
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view=layoutInflater.inflate(R.layout.custom_dashboard_item,parent,false);

        return new Holder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull adapterDashboard.Holder holder, int position) {
    ...
    public class Holder extends RecyclerView.ViewHolder {
        ...
        public Holder(@NonNull View itemView) {
            ...
            btnAddToCart.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    recyclerViewClickInterface.onClickButton(getAdapterPosition());
                }
            });
        }
